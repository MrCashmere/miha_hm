...
> 当前版本：1.1.3-OS（bundleName `com.miha.harmony`）

## 更新日志

| 版本 | 主要内容 |
| --- | --- |
| **1.1.3-OS** | 新增「主题色流光」与「卡片流光触感」开关，按压卡片的流光改用主题色并可跟手；新增「涟漪粉」「流萤绿」两个浅色主题色，主题色底上的字色按深浅自动取黑 / 白；修复切换标签页后列表不回顶部、更换主题色后底栏高亮不跟随、耗材中心文字看不清 —— [完整说明](docs/1.1.3.md) |
